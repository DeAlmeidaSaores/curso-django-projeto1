...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'base_templates'], #houve  a neccidade aqui pelo fato de a basta de que nao é um app instaldo na raiz do project, ou seja, sempre que eu precisar
...
STATICFILES_DIRS = [ #significa: procure arquivos estáticos adicinais nessa pasta
    BASE_DIR / 'base_static', #sempre que for trabalhar com pastas na base do project usa-se base_dir
